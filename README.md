🏥 HealthCarePlus - Medical Appointment Scheduling System

A professional, feature-rich healthcare appointment scheduling system built with Spring Boot, designed to streamline clinical operations for admins, doctors, and patients.
...
Automated Scheduling System: Background tasks for reminders, notifications, and system updates using Spring Scheduling.
🛠️ Technology Stack
Backend: Java 17, Spring Boot 3, Spring Security, Spring Data JPA
Database: MySQL
Frontend: Thymeleaf, Tailwind CSS, FontAwesome
Utilities: PDFBox (for records), Twilio / JavaMail (for notifications)
Automation: Spring Scheduling (@EnableScheduling)
...
Add this in your main Spring Boot application:

import org.springframework.scheduling.annotation.EnableScheduling;

@EnableScheduling
@SpringBootApplication
public class HealthCarePlusApplication {
    public static void main(String[] args) {
        SpringApplication.run(HealthCarePlusApplication.class, args);
    }
}
⏰ Scheduled System Features

The system uses Spring Scheduling for automated backend tasks:

📅 Appointment reminder notifications (email/SMS)
📊 Daily appointment summary reports for admins
💳 Payment reminder alerts for pending invoices
🧹 Automatic cleanup of expired or cancelled appointments
📩 Periodic system notification dispatch
